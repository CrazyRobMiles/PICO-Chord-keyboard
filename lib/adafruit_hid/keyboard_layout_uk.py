...
class KeyboardLayoutUK(KeyboardLayoutBase):
    ...
    ASCII_TO_KEYCODE = (
        ...
        b"\x32"  # # x20|SHIFT_FLAG (shift 3) - showing £ at the moment
...
KeyboardLayout = KeyboardLayoutUK